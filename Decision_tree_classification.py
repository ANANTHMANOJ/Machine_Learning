# -*- coding: utf-8 -*-
"""
Created on Mon Mar 25 14:17:37 2019
...
from sklearn.preprocessing import StandardScaler  #here the feature scaling is not required
sc_x=StandardScaler()
...
classifier=DecisionTreeClassifier(criterion='entropy',random_state=0)  # here we use criterion as entropy as entropy mean the function of quality of the split   if its zero then its fully homogenous group of class which is good

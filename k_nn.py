...
classifier=KNeighborsClassifier(n_neighbors=5,metric='minkowski',p=2)#for euclidien distance we should select Motric= minkowski and p=. See help for more info
